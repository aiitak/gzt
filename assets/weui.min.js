...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"<%=className%>\"> <div class=weui-mask></div> <div class=weui-dialog role=dialog aria-modal=true tabindex=-1> <% if (title) { %> <div class=weui-dialog__hd><strong class=weui-dialog__title><%=title%></strong></div> <% } %> <div class=weui-dialog__bd><%=content%></div> <div class=weui-dialog__ft> <% for(var i = 0; i < buttons.length; i++){ %> <a href=javascript:; class=\"weui-dialog__btn weui-dialog__btn_<%=buttons[i]['type']%>\" role=button><%=buttons[i]['label']%></a> <% } %> </div> </div> </div> ";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	function toast() {
	    ...
	    if (_sington) {
	        clearTimeout(_timer);
	        (0, _util2.default)(_sington).remove();
	        _sington = null;
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	*/
	...
	function actionSheet() {
	    ...
	    $actionSheet.addClass('weui-animate-slide-up').on('animationend webkitAnimationEnd', function (evt) {
	        evt.target.focus();
	    });
	    $actionSheetWrap.find('.weui-actionsheet__menu').on('click', '.weui-actionsheet__cell', function (evt) {
	        var cell = evt.target.closest('.weui-actionsheet__cell');
	        if (!cell) return;
	        var $cell = (0, _util2.default)(cell);
